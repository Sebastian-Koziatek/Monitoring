![Grafana](/grafiki/m1-pasted-image-20260608075236.png)
...
2. Przejdź do **Connections > Data Sources**.
...
1. **Tworzenie nowego dashboardu**:
   - Przejdź do **Dashboards > New Dashboard**.
...
1. Przejdź do sekcji **Alerting > Alert rules** w menu bocznym Grafany.
2. Kliknij **New alert rule** i skonfiguruj zapytanie oraz warunki (np. wartość równa 2, co odpowiada stanowi Critical).
3. Przypisz alert do **Contact point**, aby być informowanym o zmianach stanów.
