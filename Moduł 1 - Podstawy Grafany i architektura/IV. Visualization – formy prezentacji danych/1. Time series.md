![Grafana](/grafiki/m1-pasted-image-20260608074839.png)
...
1. Przejdź do **Connections > Data Sources**.
...
2. Kliknij **New alert rule** i skonfiguruj zapytanie oraz warunki (np. wartość powyżej określonego progu).
