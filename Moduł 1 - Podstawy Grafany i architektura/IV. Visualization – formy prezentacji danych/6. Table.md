![Grafana](/grafiki/m1-pasted-image-20260608074933.png)
...
2. Kliknij **New alert rule** i skonfiguruj zapytanie oraz warunki (np. wartość powyżej 90).
3. Przypisz alert do **Contact point**, aby otrzymywać powiadomienia.
